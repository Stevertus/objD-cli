...
void main(List<String> arguments) {
  final argParser = ArgParser()
    ...
    ..addFlag(
      ...
      negatable: false,
      help:
          'Easily remove all files and folders that would be generated by objD with the same options to easily clean junk.',
    )
    ..addFlag(
      'prod',
      abbr: 'p',
    ...
    ..addFlag(
      ...
      negatable: false,
      help:
          'Experimental option for spawing a seperate Isolate for each filesystem action(usually slower)',
    );
